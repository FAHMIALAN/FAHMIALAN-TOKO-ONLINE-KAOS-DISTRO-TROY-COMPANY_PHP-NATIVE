				...
				<tr>
					...
					<?php if($row['terima'] == 1){ ?>
						...
						<td>
							...
							<a href="proses/hapus.php?inv=<?= $row['invoice']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus pesanan ini?')"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
						</td>
					</tr>
					<?php
					$no++; 
